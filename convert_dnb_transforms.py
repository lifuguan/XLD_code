...
generate_json_file(scene_path = 'data/carla_pic_0603_Town01', num_cams=1, camera_list=[0], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town02', num_cams=1, camera_list=[0], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town03', num_cams=1, camera_list=[0], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town04', num_cams=1, camera_list=[0], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town05', num_cams=1, camera_list=[0], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town10', num_cams=1, camera_list=[0], offset_meters=0)

# num_cams, camera_list =3, [1, 0, 2]
generate_json_file(scene_path = 'data/carla_pic_0603_Town01', num_cams=3, camera_list=[1,0,2], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town02', num_cams=3, camera_list=[1,0,2], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town03', num_cams=3, camera_list=[1,0,2], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town04', num_cams=3, camera_list=[1,0,2], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town05', num_cams=3, camera_list=[1,0,2], offset_meters=0)
generate_json_file(scene_path = 'data/carla_pic_0603_Town10', num_cams=3, camera_list=[1,0,2], offset_meters=0)